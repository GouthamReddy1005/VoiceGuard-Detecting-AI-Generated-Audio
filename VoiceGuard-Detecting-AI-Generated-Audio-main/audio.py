...
#@st.cache_resource
#def load_model():
#    model = tf.keras.models.load_model(r"C:\Users\patlo\Desktop\VoiceGuard-Detecting-AI-Generated-Audio-main\VoiceGuard-Detecting-AI-Generated-Audio-main\deepfake_audio_detector.h5", compile=False)
#    return model
...
def load_model():
    ...
    model_path = os.path.join(script_dir, "deepfake_audio_detector.h5")
